      ...
      <v-card>
        <v-card-media height="300px">
          ...
          <v-layout column class="media" style="z-index: 9; position: absolute; width: 100%; z-index: 8">
            ...
            <v-card-title class="white--text pl-5 pt-5 pb-1">
              <div class="pb-1">
                <v-chip @click="$router.push('/users/' + card.author)">
                  <v-avatar>
        ...
        <v-list two-line class="mt-3 pb-0">
          <template v-for="(item, index) in items">
            <v-list-tile avatar :key="item.title" class="mb-2">
              <v-list-tile-avatar>
                <img :src="item.avatar">
              </v-list-tile-avatar>
              <v-list-tile-content dark style="background-color: white; border-radius: 5px;" v-ripple  @click.stop="dialog_read = true" class="pl-3">
                <v-list-tile-title v-html="item.title" style="color:#424242"></v-list-tile-title>
                <v-list-tile-sub-title style="color:#616161">{{item.subtitle}} hours played</v-list-tile-sub-title>
              </v-list-tile-content>
            </v-list-tile>
          </template>
        </v-list>
